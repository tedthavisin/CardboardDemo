...
5. **Player attached to outcome** — the end-of-round message ("Score: N")
   ...
   last round.
6. **Negotiable consequences** — nothing bad happens if you lose. It's a demo with no negative consequences
...
fish be when the next spear leaves?" — and the player engages with it purely
